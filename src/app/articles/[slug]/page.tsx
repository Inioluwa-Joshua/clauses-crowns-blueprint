      ...
      <div className="pt-32">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            ...
            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mt-4 mb-8 leading-tight">
              {article.title}
            </h1>

            <div className="flex flex-wrap gap-6 items-center text-sm text-muted-foreground border-y border-border py-6 mb-12">
                ...
                {relatedArticles.map((item, i) => (
                  <Link href={`/articles/${item.slug}`} key={item.id}>
                    <motion.article
                      ...
                      className="group bg-card border border-border p-8 h-full hover:border-accent/40 transition-all duration-500 cursor-pointer"
                    >
