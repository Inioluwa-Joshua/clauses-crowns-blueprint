...
const ArticlesClient = ({ articles }: { articles: SanityArticle[] }) => {
          ...
          <AnimatePresence mode="wait">
            ...
            >
              {featured[current].image && (
                <Image
                  src={urlFor(featured[current].image).url()}
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="lg:w-3/4">
              ...
              {filteredArticles.length > 0 ? (
                  ...
                  {filteredArticles.map((article, i) => (
                    <Link href={`/articles/${article.slug}`} key={article._id}>
                      <motion.article
                        ...
                        className="group border border-border bg-card hover:border-accent/40 transition-all duration-500 overflow-hidden cursor-pointer flex flex-col h-full"
                      >
                        {article.image && (
                        ...
                        {!article.image && (
                          <div className="relative h-24 bg-secondary overflow-hidden flex items-end p-4">
                            <span className="bg-accent text-white text-[10px] uppercase tracking-widest px-3 py-1 font-sans">
                              {article.category}
                            </span>
                          </div>
                ...
                <div className="py-20 text-center border border-dashed border-border flex flex-col items-center justify-center">
